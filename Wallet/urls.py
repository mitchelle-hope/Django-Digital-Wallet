...
from.views import register_Account, register_Card, register_Currency, register_Customer, register_Loan, register_Notifications, register_Receipts, register_Reward, register_ThirdParty, register_Transaction, register_Wallet
